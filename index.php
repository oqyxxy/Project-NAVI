...
<ul>
   	<li class='active'><a class = "fNiv" href='index.php'><span>Main</span></a></li>
...
<!-- ==================== ORBIT Slider (Content) ==================== -->
	<div class="container">
		<div id="featured" style="min-width: 800px;"> 
			<div class="content" style="">
				<!-- <h1>Orbit does content now.</h1> -->
				<!-- <h3>Highlight me...I'm text.</h3> -->
			</div>
			<a href=""><img src="Images/Index/Slider/second.png" /></a>
			<img src="Images/Index/Slider/third.png" data-caption="#htmlCaption" />
			<img src="Images/Index/Slider/forth.png"  />
		</div>
		<!-- Captions for Orbit -->
...
<!-- ==================== Table ==================== -->
<div id="ntrader_basic_intro">
	<table id = "Blocks">
		<tr>
			<td style="background-image:url(Images/image.jpg);">
                        	<div id="Title">ANNOUNCEMENT</div>
                            	<div id="Content">
					<p>[14.01]&nbsp;&nbsp;nTrader has officially launched</p>
					<p>[07.01]&nbsp;&nbsp;Update: Hangman game is now available</p>
                                	<p>[01.01]&nbsp;&nbsp;Happy 2013</p>
                            	</div>                            
                        </td>
			<td style="background-image:url(Images/image.jpg);"> 
                            	<div id="Title">WHY CHOOSE US</div>
                            	<div id="Content">
					<p style="background: url('../Images/Standard/Menu/arrow_right.png') no-repeat 8px 3px; padding-left: 25px;">Interactive real-time financial news update and analytics</p>
					<p style="background: url('../Images/Standard/Menu/arrow_right.png') no-repeat 8px 3px; padding-left: 25px;">One-stop investment kit for faster, effective decisions</p>
					<p style="background: url('../Images/Standard/Menu/arrow_right.png') no-repeat 8px 3px; padding-left: 25px;">Credible market data from Bloomberg and World Bank</p>
					<p style="background: url('../Images/Standard/Menu/arrow_right.png') no-repeat 8px 3px; padding-left: 25px;">Understand financial news and adopt it as your trading strategy</p>
                            	</div>               
                        </td>
			<td style="background-image:url(Images/image.jpg);">
                            	<div id="Title">COMING SOON</div>
				<div id="Content">
					<p>[21.01]&nbsp;&nbsp;You name it, we have it</p>
					<p>[23.01]&nbsp;&nbsp;More games will be available</p>
                                	<p>[25.01]&nbsp;&nbsp;Celebrate with us this new year</p>
				</div>
                        </td>
		</tr>
	</table>
...
<!-- ==================== JAVA (Slider) ==================== -->
	...
	<script type="text/javascript">
		...
		document.getElementById('wrapper').style.width = $(window).width() - 20; //1340 + 'px';	
