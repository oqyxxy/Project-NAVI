...
function Search_Headlines($Instrument_Code){
    ...
    $HEADLINE_QUERY = 'SELECT DATE,  GROUP_CONCAT(Headline SEPARATOR  \'<br>\' ) FROM `m0004_news_archive` 
	...
	if(isset($_SERVER['SERVER_NAME'])) { 
        ...
        $stmt->execute();
        $stmt->bind_result($Date, $Headlines);
        $i = 0;
        while($stmt->fetch()){                    
...
$SENTIMENT_QUERY  = "SELECT pos.Subject_ISO_Code, neg.Neg_Count/pos.Pos_Count as Sentiment, Pos_Count, Neg_Count FROM (\r\n";
