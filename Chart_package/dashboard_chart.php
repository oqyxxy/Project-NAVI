...
<html>
	<head>
		...
		<script type="text/javascript" src="charting/jquery.min.js"></script>
...
function add_news_flag_chart(){
    ...
    for (i = 0; i < event_flags.length; i++) {
        ...
        flag_data.push({x:Date.UTC(event_flags[i][0], event_flags[i][1], event_flags[i][2]), title: i+1, text:event_flags[i][3],events:{click: function(event){window.open(urlToQry, '_target');}}});        
    }
...
<script src="charting/highstock.js"></script>
<script src="charting/modules/exporting.js"></script>
...
<div id="div_stock_chart" style="height: 500px; min-width: 500px"></div>
